...
- Finally as mentioned above, their is no real correlation between character popularity and EVO tournament wins/placements. In the end, people will pick the characters based on their playstyle, personality, visual appeal and overall use in situations versus other characters.
...
- There are also different versions of Street Fighter being played at each EVO. This factors in greatly. Character models can change and some characters might not be in the games that's being played at that tournament. In some instances, more than one version of Street Fighter was played at the tournament.
...
**Other Notes**
- The scaper I used to scrap the wiki page did a decent job at compiling the data. However, I had to manually manipulate the CSV file to include the game that was being played at the tournaments that year.
- The popularity results were auto-generated by ChatGPT and may not be accurate.
- I drew the picture on this readme file.
